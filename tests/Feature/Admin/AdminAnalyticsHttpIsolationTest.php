...
class AdminAnalyticsHttpIsolationTest extends TestCase
{
    ...
    public function test_admin_temporal_filters_cannot_escape_scope(): void
    {
        $super = $this->user('super_admin');
        $admin = $this->user('admin');
