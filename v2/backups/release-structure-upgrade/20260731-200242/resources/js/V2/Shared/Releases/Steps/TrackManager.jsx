            ...
            {uploading && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/55 p-5 backdrop-blur-sm">
                    <div className="w-full max-w-md rounded-3xl bg-white p-7 text-center shadow-2xl">
                        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-violet-100 text-3xl text-violet-700">
                            ⇧
                        </div>
                        ...
                        <div className="mt-3 text-2xl font-bold text-violet-700">
                            {uploadProgress}%
                        </div>

                        <p className="mt-2 text-xs text-slate-500">
                            Upload complete होने तक page बंद न करें।
                        </p>
                    </div>
                </div>
            )}
