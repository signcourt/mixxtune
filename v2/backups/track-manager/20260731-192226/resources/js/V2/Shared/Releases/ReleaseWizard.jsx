                    ...
                    <div className="min-h-[420px] p-6">
                        ...
                        {currentStep === 2 && (
                            <StepPlaceholder
                                ...
                                description={
                                    release?.id
                                        ? 'Track manager will be connected in the next step.'
                                        : 'Save release details first to add tracks.'
                                }
                            />
                        )}
                        ...
                        {currentStep === 3 && (
                            <StepPlaceholder
                                ...
                                description="DSP selection, territories and delivery settings will be connected here."
                            />
                        )}
                        ...
                        {currentStep === 4 && (
                            <StepPlaceholder
                                ...
                                description="Final validation and submission workflow will be connected here."
                            />
                        )}
                    </div>
