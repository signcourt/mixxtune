            ...
            >
                ...
                <div className="border-t border-white/10 p-3">
                    <button
                        ...
                        className="mb-2 flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold text-slate-300 transition hover:bg-red-500/10 hover:text-red-300"
                    >
